...
export default function Hero() {
  return (
    <section className="relative min-h-[100vh] flex items-center justify-center bg-beige px-6 py-20 md:py-28 overflow-hidden">
      ...
      <img src="/flowers/corner-roses.png" alt="" className="flower-corner tl" aria-hidden="true" />
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img src="/flowers/corner-roses.png" alt="" className="flower-corner br" aria-hidden="true" />
